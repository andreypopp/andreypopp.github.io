...
var Page = function Page(_ref) {
  ...
  react__WEBPACK_IMPORTED_MODULE_3__["useEffect"](function () {
    console.log('R', window.location.path);

    if (scrollPositionByPath.has(window.location.path)) {
      var offsetY = scrollPositionByPath.get(window.location.path);
  ...
  var onScroll = react__WEBPACK_IMPORTED_MODULE_3__["useCallback"](function (e) {
    ...
    console.log('S', window.location.path);
    scrollPositionByPath.set(window.location.path, offsetY);
  });
...
//# sourceMappingURL=2013-11-09-recreating-core-async-tutorial-with-es6-generators.js.803ec348fcec04a43384.hot-update.js.map